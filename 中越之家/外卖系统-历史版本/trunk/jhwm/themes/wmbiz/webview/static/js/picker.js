!function (a) {
    "use strict";
    var h, i, j, k, l, m, b = {}, c = navigator.userAgent, d = c.match(/(Android);?[\s\/]+([\d.]+)?/), e = c.match(/(iPad).*OS\s([\d_]+)/), f = c.match(/(iPod)(.*OS\s([\d_]+))?/), g = !e && c.match(/(iPhone\sOS)\s([\d_]+)/);
    ...
    var b = function (b) {
        ...
        function i() {
            if (c.opened)for (var a = 0; a < c.cols.length; a++)c.cols[a].divider || (c.cols[a].calcSize(), c.cols[a].setValue(c.cols[a].value, 0, !1))
        }
        ...
        function j(a) {
            ...
            if (a.preventDefault(), !c.opened && (c.open(), c.params.scrollToInput && !g())) {
                ...
                d = parseInt(b.css("padding-top"), 10), e = parseInt(b.css("padding-bottom"), 10), f = b[0].offsetHeight - d - c.container.height(), h = b[0].scrollHeight - d - c.container.height(), j = c.input.offset().top - d + c.input[0].offsetHeight, j > f && (k = b.scrollTop() + j - f, k + f > h && (i = k + f - h + e, f === h && (i = c.container.height()), b.css({"padding-bottom": i + "px"})), b.scrollTop(k, 300))
            }
        }
        ...
        return c.params = b, c.cols = [], c.initialized = !1, c.inline = c.params.container ? !0 : !1, f = a.device.ios || navigator.userAgent.toLowerCase().indexOf("safari") >= 0 && navigator.userAgent.toLowerCase().indexOf("chrome") < 0 && !a.device.android, c.setValue = function (a, b) {
            ...
            var k, l, m, n, o, q, s, t, u, v, w, x, y, z, A, B, C, D, E, e = a(b), g = e.index(), h = c.cols[g];
            h.divider || (h.container = e, h.wrapper = h.container.find(".picker-items-col-wrapper"), h.items = h.wrapper.find(".picker-item"), h.replaceValues = function (a, b) {
                ...
                var b, d;
                b = 0, d = h.container[0].offsetHeight, k = h.wrapper[0].offsetHeight, l = h.items[0].offsetHeight, m = l * h.items.length, n = d / 2 - m + l / 2, o = d / 2 - l / 2, h.width && (b = h.width, parseInt(b, 10) === b && (b += "px"), h.container.css({width: b})), c.params.rotateEffect && (h.width || (h.items.each(function () {
                    var c = a(this);
                    c.css({width: "auto"}), b = Math.max(b, c[0].offsetWidth), c.css({width: ""})
                }), h.container.css({width: b + 2 + "px"})), h.container.addClass("picker-items-col-absolute"))
                ...
                "undefined" == typeof d && (d = a.getTranslate(h.wrapper[0], "y")), "undefined" == typeof b && (b = -Math.round((d - o) / l)), 0 > b && (b = 0), b >= h.items.length && (b = h.items.length - 1), i = h.activeIndex, h.activeIndex = b, h.wrapper.find(".picker-selected").removeClass("picker-selected"), c.params.rotateEffect && h.items.transition(e), j = h.items.eq(b).addClass("picker-selected").transform(""), (g || "undefined" == typeof g) && (h.value = j.attr("data-picker-value"), h.displayValue = h.displayValues ? h.displayValues[b] : h.value, i !== b && (h.onChange && h.onChange(c, h.value, h.displayValue), c.updateValue())), c.params.rotateEffect && ((d - (Math.floor((d - o) / l) * l + o)) / l, h.items.each(function () {
                    var b = a(this), c = b.index() * l, e = o - d, g = c - e, i = g / l, j = Math.ceil(h.height / l / 2) + 1, k = -18 * i;
            ...
            if (a.divider)d += '<div class="picker-items-col picker-items-col-divider ' + (a.textAlign ? "picker-items-col-" + a.textAlign : "") + " " + (a.cssClass || "") + '">' + a.content + "</div>"; else {
                for (e = 0; e < a.values.length; e++)c += '<div class="picker-item" data-picker-value="' + a.values[e] + '" data-level="'+a.cssClass+'" >' + (a.displayValues ? a.displayValues[e] : a.values[e]) + "</div>";
    ...
    a(document).on("click", ".close-picker", function () {
        ...
        return this.each(function () {
            var e, f, g, h;
            this && (e = a(this), f = e.data("picker"), f || (c = c || {}, g = e.val(), void 0 === c.value && "" !== g && (c.value = c.cols.length > 1 ? g.split(" ") : [g]), h = a.extend({input: this}, c), f = new b(h), e.data("picker", f)), "string" == typeof c && f[c].apply(f, Array.prototype.slice.call(d, 1)))
        })
    }
}($), +function (a) {
    "use strict";
    ...
    a.fn.datetimePicker = function (c) {
        return c = a.extend({}, b, c), this.each(function () {
            ...
            this && (b = new Date, d = function (a) {
                var c, b = [];
                for (c = 1; (a || 31) >= c; c++)b.push(10 > c ? "0" + c : c);
                return b
            }, e = function (a, b) {
                var c = new Date(b, parseInt(a) + 1 - 1, 1), e = new Date(c - 1);
                return d(e.getDate())
            }, f = function (a) {
                return 10 > a ? "0" + a : a
            }, g = function (a) {
                ...
                return a
            }(), 0 == c.m ? (k = [b.getFullYear(), f(b.getMonth() + 1), f(b.getDate()), f(b.getHours()), f(b.getMinutes())], l = [{values: i}, {values: h}, {values: d()}, {
                divider: !0,
                content: " "
            }, {
                values: function () {
            ...
            }]) : 1 == c.m && (k = [b.getFullYear(), f(b.getMonth() + 1), f(b.getDate())], l = [{values: i}, {values: h}, {values: d()}]), m = {
                rotateEffect: !1,
                value: k,
                onChange: function (a, b, d) {
                    var k, l, m, n, f = a.cols, h = e(f[1].value, f[0].value), i = a.cols[2].value;
    ...
    }, b = a.fn.datetimePicker.prototype.defaults = {dateSplit: "-", timeSplit: ":", min: void 0, max: void 0, m: 0}
}($);