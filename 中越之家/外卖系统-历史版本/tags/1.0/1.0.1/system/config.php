...
class __CFG
{
    ...
    CONST MYSQL = 'mysql://jhwm:jhwm@192.168.0.1:3306/jhwm/jh_/UTF8';
    ...
    CONST C_PREFIX  = 'KT-';
    CONST C_PATH    = '/';
    CONST C_DOMAIN  = '.waimai.zyzjgzh.cn';
    ...
    static $APPS = array(
        'www' => array('title'=>'默认', 'url'=>'http://waimai.zyzjgzh.cn', 'rewrite'=>true),
		'home' => array('title'=>'默认', 'url'=>'http://waimai.zyzjgzh.cn', 'rewrite'=>true),
        'waimai' => array('title'=>'默认', 'url'=>'http://waimai.zyzjgzh.cn/waimai', 'rewrite'=>true),
        'admin' => array('title'=>'后台', 'url'=>'http://waimai.zyzjgzh.cn/admin', 'rewrite'=>false),
        'wmbiz' => array('title'=>'商户', 'url'=>'http://waimai.zyzjgzh.cn/wmbiz', 'rewrite'=>false),
        'staff'=>array('title'=>'骑手','url'=>'http://waimai.zyzjgzh.cn/staff','rewrite'=>true),
        'jifen'=>array('title'=>'骑手','url'=>'http://waimai.zyzjgzh.cn/jifen','rewrite'=>true),
        'pei'=>array('title'=>'配送团队','url'=>'http://waimai.zyzjgzh.cn/pei','rewrite'=>true),
        'ditui'=>array('title'=>'地推','url'=>'http://waimai.zyzjgzh.cn/ditui','rewrite'=>true),
        'paotui'=>array('title'=>'跑腿','url'=>'http://waimai.zyzjgzh.cn/paotui','rewrite'=>true),
        'dispatch'=>array('title'=>'调度站','url'=>'http://waimai.zyzjgzh.cn/dispatch','rewrite'=>true),
        'qiang'=>array('title'=>'抢购','url'=>'http://waimai.zyzjgzh.cn/qiang','rewrite'=>true),
    );
}
...
//地图相关配置
define("MAP_KEY","942f0ec4d152d1f3d163168d43916de6");//地图秘钥 --使用高德地图所使用的key
define("MAP_SERVER_KEY","ccfe0f51eeba3b2d158565f9ef386c41");//高德地图 --服务端接口所使用的key
//地图相关配置结束
