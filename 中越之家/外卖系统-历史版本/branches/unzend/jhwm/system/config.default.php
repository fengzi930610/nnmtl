...
class __CFG
{
    ...
    CONST SECRET_KEY = 'ace23d460de7ccb1347e6f29e6e209ea';
    CONST Authorize = '2ef6089722ad45ed4e1be4c04ff54060';

    //Cookie
    CONST C_PREFIX  = 'KT-';
    CONST C_PATH    = '/';
    CONST C_DOMAIN  = '.install.cn';
    ...
    static $APPS = array(
        'www' => array('title'=>'默认', 'url'=>'http://install.cn', 'rewrite'=>true),
		'home' => array('title'=>'默认', 'url'=>'http://install.cn', 'rewrite'=>true),
        'waimai' => array('title'=>'默认', 'url'=>'http://install.cn/waimai', 'rewrite'=>true),
        'admin' => array('title'=>'后台', 'url'=>'http://install.cn/admin', 'rewrite'=>false),
        'wmbiz' => array('title'=>'商户', 'url'=>'http://install.cn/wmbiz', 'rewrite'=>false),
        'staff'=>array('title'=>'骑手','url'=>'http://install.cn/staff','rewrite'=>true),
        'jifen'=>array('title'=>'骑手','url'=>'http://install.cn/jifen','rewrite'=>true),
        'pei'=>array('title'=>'配送团队','url'=>'http://install.cn/pei','rewrite'=>true),
        'ditui'=>array('title'=>'地推','url'=>'http://install.cn/ditui','rewrite'=>true),
        'paotui'=>array('title'=>'跑腿','url'=>'http://install.cn/paotui','rewrite'=>true),
        'dispatch'=>array('title'=>'调度站','url'=>'http://install.cn/dispatch','rewrite'=>true),
        'qiang'=>array('title'=>'抢购','url'=>'http://install.cn/qiang','rewrite'=>true),
    );
}
